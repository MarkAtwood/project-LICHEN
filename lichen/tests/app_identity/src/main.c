...
/* Upstream Yggdrasil AddrForKey of the derived test pubkey
 * (schnorr48_derive_keypair(test_seed) -> 03a107bf...5531b8);
 * oracle: yggdrasil-go@422836ee address_test.go anchor, cross-checked
 * with an independent port — never the C impl. */
static const uint8_t test_ygg_addr[16] = {
	0x02, 0x06, 0x2f, 0x7c, 0x20, 0x06, 0x18, 0xf7,
	0xa0, 0xf1, 0x47, 0x91, 0x73, 0x8c, 0x5a, 0x1f,
};
