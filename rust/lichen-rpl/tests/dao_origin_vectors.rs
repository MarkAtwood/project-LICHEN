...
fn dao_origin_signature_vectors_match_fixed_literals() {
    // UPSTREAM-AddrForKey variant of the shared corpus, regenerated by the
    // canonical generator with the derivation swapped per the settled
    // `upstream-yggdrasil-addressing` decision (i72x.2). The shared
...
fn exact_lengths_unknown_options_and_d0_scope_reject_before_crypto() {
    // Wire + origin from the upstream-AddrForKey corpus variant
    // (valid_d0_self_128; see the note on the corpus test above).
    let d0 = hex("0000002a051200800202fc2fcc3b6bef0ed144787022f9dc06140080f1fffe8000000000000000000000000000011238000000000000002b9fc2cc5ae74b70d4e68626d85e0806f2720e50cc79d23349fffaaa685f837c082d1782a9c60510bc2069088fbf1cca08");
    let source = hex("0202fc2fcc3b6bef0ed144787022f9dc").try_into().unwrap();
