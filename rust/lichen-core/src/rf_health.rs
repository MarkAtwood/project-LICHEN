...
impl RfHealthMetrics {
    ...
    /// §2a.8 (post-step-6 minimum-SF floors included). Takes table-assigned
    /// SF, utilization (scaled by `util_fp_scale`), and per-neighbor EMA loss
    /// (Q16.16). Returns (sf, tx_allowed).
    #[inline]
