...
mod tests {
    ...
    fn rfc9529_signature_trace_vectors() {
        ...
        let keystream_2 = hex!(
            "58b05266fc4dd54d266c281cde1c718441967d35f11122a7a441d9c5f3e1634821d08f369eacae7d65d9d8cdc2f83a93ca5af36b79c062e2a74dd80c4fd2cea4d5027a8cb6cbee4a6dbb36b870a26408e6a9"
        );
        assert_eq!(
        ...
        let prk_out = hex!("e06524feac742d6ed47ec276dbf9f09eb5263d6d6f9688023e62200dbeebace5");
        assert_eq!(
            edhoc_kdf(&prk_2e, &th_4, "PRK_out", &[], 32).unwrap().as_slice(),
            prk_out
        );
        let prk_exporter = hex!("29e0ecd0056e59189c0bcce988e6ca20c16dd5e555723cac00fc52bdceebec24");
        assert_eq!(
        ...
        assert_eq!(
            ...
            &hex!("d8fd75b65b081cc15a5d615d36ba020c")
        );
        assert_eq!(
            edhoc_kdf(&prk_exporter, &th_4, "1", &[], 8).unwrap().as_slice(),
            &hex!("bb0eb198a99141e5")
        );
