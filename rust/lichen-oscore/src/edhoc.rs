...
mod tests {
    ...
    fn rfc9529_signature_trace_vectors() {
        ...
        let keystream_2 = hex!(
            "4c6e835c7d70ae6f555a42b4cd426791f0345cc6b0d58553e01950aa191216678d523f013af73c5316ecccb8882931552b3b4e4f83610d848296fba44cdd4c03f2cb45aea6da35336bc18b9920d39e36b9b6"
        );
        assert_eq!(
        ...
        let prk_out = hex!("85d7f3d98a24a7f5ba2d3833457960f079c9ef298ba88be0ccd55114f0f123eb");
        assert_eq!(
            edhoc_kdf(&prk_2e, &th_4, "PRK_out", &[], 32).unwrap().as_slice(),
            prk_out
        );
        let prk_exporter = hex!("a1e1cccdbc0c31f3006323df9f88ef0754758035475562ad19e04aabeed83096");
        assert_eq!(
        ...
        assert_eq!(
            ...
            &hex!("3f23236ad30d5af2e4848bffce0b434e")
        );
        assert_eq!(
            edhoc_kdf(&prk_exporter, &th_4, "1", &[], 8).unwrap().as_slice(),
            &hex!("9e4108fc66265e8c")
        );
