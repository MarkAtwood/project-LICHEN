...
mod tests {
    ...
    fn rfc9529_signature_trace_vectors() {
        ...
        let keystream_2 = hex!(
            "0c20f90535496a71713af105a5fe5e880fb8e576981baa46176d4c88982758d5167a5b77cd8171404ab7c9ab1ce4452c0e915adb61cb871ab981c91db7cd104338367faba76c38c0d5b428a25d49e4fa81de"
        );
        assert_eq!(
        ...
        let prk_out = hex!("67135c119d926b57ff0cd0b87cb11c6523a29bdf7616007b5d76c477323a8b83");
        assert_eq!(
            edhoc_kdf(&prk_2e, &th_4, "PRK_out", &[], 32).unwrap().as_slice(),
            prk_out
        );
        let prk_exporter = hex!("ba0abc1ff053642a742b7a08eddf6c78775a6bd06d84ff5d2cb7244c977210d6");
        assert_eq!(
        ...
        assert_eq!(
            ...
            &hex!("49a3a51c2d5dac1bd34781029636e2d3")
        );
        assert_eq!(
            edhoc_kdf(&prk_exporter, &th_4, "1", &[], 8).unwrap().as_slice(),
            &hex!("3330205c64ff06e9")
        );
