...
mod tests {
    ...
    fn capability_announce_dispatch() {
        ...
        // IID is the SHA-512 link-local IID, derived directly (the routable
        // address no longer embeds it after the upstream-AddrForKey migration).
        let announcer_iid = lichen_core::addr::iid_from_pubkey_bytes(&pubkey);
    ...
    fn capability_announce_rejects_recover_and_table_full_is_503() {
        ...
        let announcer_iid2 = lichen_core::addr::iid_from_pubkey_bytes(&pubkey2);
